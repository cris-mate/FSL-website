...
<div class="card card-hover mb-4">
  <div class="card-body">
    ...
    <p>
      ...
      25018 Montichiari (BS)</strong>. Lo studio è una ditta individuale specializzata in 
...
<div class="card card-hover mb-4">
  <div class="card-body">
    ...
    <div class="row g-3">
      <div class="col-md-7">
        <img src="/MateiManuelaNatalis_FSL/img/vista_dalla_strada.jpg" 
      ...
      <div class="col-md-5">
        <img src="/MateiManuelaNatalis_FSL/img/posizione_mappa.jpg" 
